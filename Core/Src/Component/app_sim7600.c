...
#define TIMEOUT_STARTUP_RESET					2000		/*!< Time for Simcom7600 wait Start up 20000 Ticks equal 200000 miliseconds*/

#define TIMEOUT_SETTING_COMMAND					2000		/*!< Time for Simcom7600 wait Start up 20000 Ticks equal 200000 miliseconds*/
 ...
 */
void Sim7600_Reset(void){
	UART_SIM7600_Transmit("AT+CRESET\r\n");
	Clear_Sim7600_Timeout_Flag();
